/*
  ...
  - Added the required column `created_by` to the `stamp_images` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `stamp_images` ADD COLUMN `created_by` INTEGER NOT NULL;
